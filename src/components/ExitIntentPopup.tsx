      ...
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[90%] max-w-md animate-in zoom-in-95 duration-200">
        <div className="relative rounded-2xl border border-[#d4bc91]/60 bg-[#faf8f4] p-8 shadow-2xl">
          ...
          <p className="font-lora text-[14px] text-center text-[#6b5344] leading-relaxed mb-5">
            Restore unlimited photos in HD — one-time $4.99, no subscription, results in 30 seconds.
          </p>

          {/* Benefits */}
          <div className="mb-6 space-y-2">
            {[
              "Unlimited HD restorations after unlock",
              "One-time $4.99 — no subscription, no recurring fees",
          ...
          <Link
            ...
            onClick={handleClose}
            className="group relative inline-flex w-full h-12 items-center justify-center rounded-full bg-gradient-to-r from-[#0071e3] to-[#0084ff] px-6 font-lora text-[15px] font-600 text-white hover:from-[#0077ed] hover:to-[#0090ff] hover:shadow-xl active:scale-[0.98] transition-all duration-200 shadow-lg shadow-[#0071e3]/30 overflow-hidden"
          >
            <span className="relative z-10 flex items-center gap-2">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
              </svg>
              Unlock HD Restoration — $4.99
