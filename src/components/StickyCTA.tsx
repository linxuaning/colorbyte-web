        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-3">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <Link
              ...
              className="group relative inline-flex h-11 items-center rounded-full bg-gradient-to-r from-[#0071e3] to-[#0084ff] px-7 font-lora text-[15px] font-600 text-white hover:from-[#0077ed] hover:to-[#0090ff] hover:shadow-xl active:scale-[0.98] transition-all duration-200 shadow-lg shadow-[#0071e3]/25 whitespace-nowrap overflow-hidden"
            >
