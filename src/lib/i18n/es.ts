...
export const es: LocaleSEO = {
  oldPhotoRestoration: {
    ...
    // 2026-05-11: expanded to 8 items at 140-160 words each per Wave 4 P2
    // Spanish Nick Brown hub (Mariella's converting locale validates ES).
    faqItems: [
      { q: "¿Necesito pagar antes de subir una foto para restaurar?", a: "Sí — ArtImageHub utiliza un modelo de pago previo en el que un único pago de $4,99 desbloquea la subida, el procesamiento por IA y la descarga HD original sobre tu dirección de correo electrónico. No hay suscripción recurrente, ni cuota mensual, ni cargo por foto después del desbloqueo inicial. La razón del pago previo en lugar de la vista previa gratuita es mantener un camino de conversión limpio y evitar la experiencia de cebo y cambio común en otras herramientas que ponen marca de agua o reducen la calidad de tu resultado hasta que pagas. Después del pago, vuelves a la herramienta con el mismo correo y subes tu foto dañada, desvanecida, rayada o en blanco y negro. Tu acceso queda ligado a ese correo, así que puedes volver más tarde a restaurar fotos adicionales o descargar de nuevo resultados anteriores sin entrar en otro ciclo de facturación." },
      { q: "¿Qué formatos de imagen y tamaños de archivo admite ArtImageHub para la restauración fotográfica?", a: "ArtImageHub acepta los formatos JPG, JPEG, PNG y WEBP de hasta 20 MB por archivo. Para fotografías antiguas escaneadas a partir de copias físicas, recomendamos escanear los originales a 600 DPI o más y guardarlos como PNG para obtener los mejores resultados de restauración por IA — una mayor resolución de origen le da a la IA más datos de píxeles con los que trabajar, especialmente para la recuperación del detalle facial y la reparación de rayaduras. JPG es válido para la mayoría de las fotos modernas y los escaneos más pequeños. WEBP es compatible pero poco común para escaneos de fotos antiguas. Los archivos superiores a 20 MB deben reducirse en el software del escáner antes de subirlos; la IA no se beneficia del sobre-muestreo extremo por encima de los 24 megapíxeles. HEIC del iPhone no es compatible actualmente — conviértelo primero a JPG." },
      { q: "¿Cuánto tarda la restauración fotográfica por IA por foto?", a: "La mayoría de las fotos terminan la restauración en 30 a 90 segundos de extremo a extremo en una subida estándar. Las imágenes complejas con daños físicos severos, múltiples rostros, archivos de origen muy grandes o fotos que requieran colorización además de restauración pueden tardar hasta 3 minutos. El pipeline de IA ejecuta la reparación de rayaduras, la corrección del desvanecimiento, el reequilibrio del color, la mejora facial (vía GFPGAN) y el escalado a 4x super-resolución (vía Real-ESRGAN) en una sola pasada coordinada — no como pasos separados que tengas que encadenar manualmente. El tiempo total de procesamiento está dominado por el tamaño del archivo de origen y el número de rostros distintos detectados. Si el procesamiento supera los 3 minutos, el sistema muestra un indicador de progreso y el resultado se entrega automáticamente a tu página de acceso ligado al correo." },
      { q: "¿Mis fotos se mantienen privadas y seguras durante la restauración por IA?", a: "Sí. Todas las fotos se transmiten mediante conexiones HTTPS cifradas durante la subida, el procesamiento y la descarga. Las fotos subidas se eliminan automática y permanentemente de nuestros servidores en un plazo de 24 horas desde la finalización de la restauración — sin retención extendida, sin almacenamiento de archivo, sin copia de seguridad en la nube más allá de esa ventana de 24 horas. Nunca compartimos tus fotos con terceros, nunca las vendemos a corredores de datos y nunca entrenamos modelos de IA con tus imágenes subidas. Los modelos de mejora facial y escalado que usamos (GFPGAN y Real-ESRGAN) son modelos de código abierto preentrenados publicados por sus autores; no los afinamos con datos de clientes. Tu resultado restaurado también se elimina junto con el original tras la ventana de 24 horas — descarga tu resultado HD antes de que caduque. El acceso a nivel de cuenta queda ligado a tu correo de forma indefinida." },
      { q: "¿Puede la IA restaurar una foto muy dañada o rota?", a: "La restauración por IA funciona mejor cuando queda alguna información de imagen subyacente sobre la que el modelo pueda reconstruir. Las fotos con daños moderados — desvanecimiento, rayaduras, manchas de agua, ligeras arrugas, cambio de color, ligero rasgado en un borde — se restauran típicamente con excelente calidad porque la IA tiene señal con la que trabajar. Los daños físicos severos como secciones grandes que faltan, crecimiento intenso de moho, fotografías rotas a través del rostro o daños químicos que destruyeron la capa de plata limitan fundamentalmente lo que la IA puede recuperar, ya que el modelo no puede inventar detalles que ya no existen en la fuente. Para estos casos extremos, la IA maneja bien las áreas no dañadas circundantes, pero la sección más dañada puede necesitar retoque manual en Photoshop o restauración profesional. Prueba primero la vista previa gratuita — la mayoría de las fotos son más recuperables de lo que parecen." },
      { q: "¿La restauración por IA cambia cómo lucen las personas en las fotos familiares antiguas?", a: "Nuestro modelo de mejora facial (GFPGAN, Wang et al., Tencent ARC Lab, 2021) está específicamente entrenado para preservar la identidad — recupera nitidez y detalles ausentes manteniendo las características faciales, la expresión y la estructura ósea de cada persona tal como aparecían originalmente. Los resultados coinciden con la identidad original en más del 95 por ciento de los casos de prueba según la evaluación publicada del modelo, con la pequeña tasa de fallo concentrada en fotos donde el rostro original estaba tan degradado que la IA tuvo que reconstruir a partir de información limitada. Siempre recomendamos comparar la salida de la IA con el original, especialmente para rostros gravemente dañados o para trabajos de genealogía donde la preservación exacta del parecido importa. Si un rostro en particular vuelve demasiado suavizado o con rasgos sutilmente diferentes, puedes volver a ejecutar la restauración sin colorización." },
      { q: "¿Cómo funciona el precio de ArtImageHub comparado con los competidores por suscripción?", a: "ArtImageHub utiliza un modelo de pago único de $4,99 — sin suscripción, sin cuota mensual, sin medición por foto después del desbloqueo inicial. Tu pago desbloquea el acceso para subir, el procesamiento por IA y la descarga HD original sobre tu dirección de correo, y ese acceso persiste, así que puedes volver más tarde para restaurar fotos adicionales o descargar de nuevo resultados anteriores sin pagar otra vez. Esto es intencionalmente diferente de competidores por suscripción como Remini ($9,99/mes, unos $120/año) o MyHeritage ($129–299/año), que solo resultan económicos si restauras fotos nuevas cada semana. Para la mayoría de los proyectos de restauración fotográfica familiar — típicamente 20 a 100 fotos restauradas una vez durante un período finito — un único pago de $4,99 es dramáticamente más barato que cualquier suscripción. ¿Preguntas? Escribe a support@artimagehub.com." },
      { q: "¿Qué tecnología y modelos de IA impulsan la restauración fotográfica de ArtImageHub?", a: "ArtImageHub ejecuta un pipeline construido sobre dos modelos de IA de código abierto y revisados por pares: GFPGAN (Wang et al., Tencent ARC Lab, 2021) para la reconstrucción facial consciente del rostro y la mejora que preserva la identidad, y Real-ESRGAN (Wang et al., 2021) para el escalado a 4x super-resolución sobre toda la imagen. Ambos artículos son trabajos académicos publicados y ampliamente citados en la investigación sobre restauración de imágenes, y ambos modelos también se usan en otros pipelines comerciales de restauración fotográfica — la calidad de IA subyacente entre la mayoría de las herramientas de consumo es más similar de lo que el marketing sugiere. El diferenciador de ArtImageHub es el flujo de trabajo integrado (reparación de rayaduras, corrección del desvanecimiento, colorización, escalado, mejora facial todo en una pasada), el modelo de pago único y el acceso ligado al correo que te permite volver más tarde sin pagar de nuevo. La colorización opcional usa una pasada de auto-colorización separada cuando se habilita en el momento de la subida." },
    ],
    howToSteps: [
