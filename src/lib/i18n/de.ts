...
export const de: LocaleSEO = {
  ...
  colorizer: {
    ...
    ctaSecondary: "Beispiele ansehen",
    faqItems: [
      { q: "Ist das Colorieren von Fotos kostenlos?", a: "Ja — die Vorschau der Colorierung ist kostenlos. Für den Download des Ergebnisses in Originalqualität ist ein Pro Lifetime Access ($4,99 einmalig) erforderlich. Kein Abonnement." },
    ...
    howToSteps: [
      { name: "Schwarz-Weiß-Foto hochladen", text: "Laden Sie ein beliebiges Schwarz-Weiß- oder Graustufenfoto hoch. Unterstützte Formate: JPG, PNG, WEBP bis zu 20 MB. Ohne Registrierung." },
      { name: "KI coloriert Ihr Foto in Sekunden", text: "Die KI fügt Ihrem Foto automatisch realistische, natürliche Farben hinzu. Ergebnisse in 30 Sekunden bereit." },
      { name: "Kostenlose Vorschau, HD-Download mit Pro", text: "Sehen Sie das colorierte Ergebnis sofort kostenlos in der Vorschau. Pro Lifetime Access ($4,99 einmalig) schaltet den HD-Download in Originalqualität frei." },
    ],
  },
  enhancer: {
    ...
    ctaSecondary: "Beispiele ansehen",
    faqItems: [
      { q: "Ist das Verbessern von Fotos kostenlos?", a: "Ja — die Vorschau der Verbesserung ist kostenlos. Für den Download des Ergebnisses in Originalqualität ist ein Pro Lifetime Access ($4,99 einmalig) erforderlich. Kein Abonnement." },
    ...
    howToSteps: [
      { name: "Foto hochladen", text: "Laden Sie ein beliebiges unscharfes, niedrig aufgelöstes oder qualitativ schlechtes Foto hoch. Unterstützte Formate: JPG, PNG, WEBP bis zu 20 MB. Ohne Registrierung." },
      { name: "KI verbessert Ihr Foto in Sekunden", text: "Die KI entfernt Unschärfe, erhöht die Auflösung bis zu 4× und verbessert Gesichtsdetails automatisch. Ergebnisse in 30 Sekunden bereit." },
      { name: "Kostenlose Vorschau, HD-Download mit Pro", text: "Sehen Sie das verbesserte Ergebnis sofort kostenlos in der Vorschau. Pro Lifetime Access ($4,99 einmalig) schaltet den HD-Download in Originalqualität frei." },
    ],
  },
};
