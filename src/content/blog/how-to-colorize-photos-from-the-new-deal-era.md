...
Most FSA and CCC photographers through approximately 1935 used orthochromatic film, which has dramatically reduced sensitivity to red wavelengths. On orthochromatic film, red objects appear unnaturally dark — a red barn may appear nearly black, while blue sky renders much lighter than it would on panchromatic film or to the human eye.

After 1934-1936, panchromatic film became increasingly standard, and the tonal rendering becomes closer to human color perception. When colorizing orthochromatic photographs with DDColor, the model may slightly misinterpret very dark red objects (interpreting them as genuinely dark-colored rather than photographically suppressed red) and may assign slightly different hues to sky areas than you would expect. This is worth checking in the preview: agricultural equipment, brick buildings, and red fabric may render darker or more orange-brown than period-accurate.
...
Many New Deal photographs survive as small-format original prints or as copy prints from archival negatives. The standard medium format of the era (2.25x3.25 inches from 120 film) produces modest-sized prints, and contact prints at this size contain significant fine detail in faces and clothing textures that is difficult to read without magnification.

**Real-ESRGAN** processes these small originals before colorization, upscaling and sharpening to extract as much detail as possible from the source file. This preparation phase matters for colorization quality: DDColor assigns more accurate colors to a sharper, higher-resolution image than to a soft, small-format original, because the texture data that constrains color assignment is more legible at higher resolution.

## What Color Research Sources Are Most Useful for Verification?

The accuracy of any colorization, AI-assisted or manual, is only as good as the reference material you use to verify it. For New Deal era photographs, several sources provide reliable period-accurate color data:

**Jack Delano's color FSA photographs** (1940-1943) are the single most valuable reference source. Delano shot color Kodachrome for the FSA starting in 1940 — making him one of the earliest documentary color photographers — and his subjects, locations, and visual language are almost identical to the better-known Dorothea Lange and Walker Evans black-and-white work. His photographs are available at high resolution through the Library of Congress Prints and Photographs Division and are searchable by state and subject.

**Marion Post Wolcott's notebooks and field notes** document color conditions for a number of her FSA photographs, including notes on clothing colors of subjects she photographed in the rural South. These are available through the Library of Congress finding aids.

**U.S. Army Quartermaster Corps supply specifications** from the 1930s document the exact shade designations for CCC uniform components, which were drawn from Army surplus stock. The Army Olive Drab No. 3 specification is the authoritative reference for CCC uniform color.

**WPA mural color documentation** provides a secondary reference for the visual culture of the period. WPA muralists documented their color choices in project reports, and their palette — which reflects the same landscape and working-class settings appearing in documentary photographs — provides a corroborating reference for common subject colors.
