...
coverEmoji: "✨"
faq:
  - question: "Can AI restoration handle can google gemini restore old photos? (honest answer + what actually works)?"
    answer: "Yes. AI restoration via GFPGAN (face) + Real-ESRGAN (upscale) handles most cases of can google gemini restore old photos? (honest answer + what actually works) effectively. Upload, wait ~60 seconds, download. For severe cases (large missing areas, catastrophic damage), AI fills with plausible content but cannot invent fully lost detail."
