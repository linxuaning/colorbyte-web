...
coverEmoji: "🏠"
faq:
  - question: "Can AI restoration handle basement flood destroyed 40 years of photos?"
    answer: "Yes. AI restoration via GFPGAN (face) + Real-ESRGAN (upscale) handles most cases of basement flood destroyed 40 years of photos effectively. Upload, wait ~60 seconds, download. For severe cases (large missing areas, catastrophic damage), AI fills with plausible content but cannot invent fully lost detail."
...
**My workflow now:**
1. FastFoto scan at 600 DPI
2. Auto-upload to Google Photos (unlimited "high quality" storage, free)
3. Also save to external drive
4. Backblaze backs up external drive to cloud automatically
5. Result: 3 copies (Google, local drive, Backblaze) on 2 media types (cloud + physical) with 2 offsite (Google + Backblaze)
...
| Location | Avg Temp | Temp Range | Avg Humidity | Verdict |
|----------|----------|------------|--------------|---------|
| **Basement** | 65°F | 55–82°F | 68% | ❌ TERRIBLE (learned the hard way) |
| **Attic** | 78°F | 62–105°F | 45% | ❌ Too hot in summer |
| **Garage** | 69°F | 45–95°F | 52% | ❌ Huge temp swings |
| **Main floor closet** | 72°F | 70–74°F | 42% | ✅ EXCELLENT |
| **Under bed (main floor)** | 71°F | 69–73°F | 40% | ✅ VERY GOOD |
...
**Test I did:**
Bought 6 different storage containers, filled with paper, submerged in bathtub for 4 hours.

**Results:**

1. **Cardboard boxes** (our mistake): Disintegrated in 30 minutes ❌
2. **Regular plastic tubs**: Water seeped in through lid seal after 2 hours ❌
3. **"Weathertight" containers** (Sterilite): No water intrusion ✅
4. **Pelican cases** (expensive but rated IP67): No water intrusion ✅
5. **Ziploc bags inside plastic tubs**: Inner bags kept photos dry even when tub leaked ✅ (cheapest solution!)
6. **Archival boxes inside weathertight containers**: Best of both (archival quality + water protection) ✅✅
...
**Total spent: $1,800**
**Photos saved to print-quality: 87 of 100 (Tier 1+2)**
**Success rate: 87%**
...
1. **Identify the hoarder** (lovingly)—usually an older relative with boxes of unsorted photos
2. **Bring equipment** to their house (scanner, laptop, hard drive)
3. **Scan while visiting** (makes it social, not a chore)
4. **Give them a USB drive** with all their photos backed up before I leave
5. **Upload to shared Google Photos album** so whole family has access
...
**Total photos digitized: 1,500**
**Total disasters prevented: Potentially 1,500 (if their basements flood)**
...
| Item | Cost | Our Reality |
|------|------|-------------|
| Archival storage materials | $105 | Cardboard boxes: $0 (false savings) |
| Scanner | $220 | "Will do it later": $0 |
| Cloud backup (1 year) | $99 | $0 |
| Time to scan | 8 hours | 0 hours |
| **Total prevention cost** | **$424** | **$0** |

**What we ACTUALLY spent (recovery after flood):**

| Item | Cost |
|------|------|
| Water damage restoration | $3,400 |
| Archival supplies (after the fact) | $75 |
| Scanner (rushed purchase) | $549 |
| External hard drive | $89 |
| Cloud backup | $99 |
| Professional photo restoration | $1,000 |
| Adobe Lightroom (2 months) | $20 |
| Printing replacements | $180 |
| My time (60 hours @ $30/hour value) | $1,800 |
| **Total disaster recovery cost** | **$7,212** |
...
**Total investment: 1 hour + $0 (using phone camera)**
**Protection gained: Your 20 most treasured photos backed up**

## The Bottom Line

My parents' basement flood destroyed 1,100 family photos.

**Cost of prevention: $424**
**Cost of recovery: $7,212**
**Cost of lost photos: Immeasurable**

You have old photos somewhere in your house right now. In a basement, attic, garage, or old album.

**They are deteriorating.**
**They are vulnerable.**
**And "I'll do it later" means you'll never do it.**
...
**Short answer:** Interior closets or under-bed storage on temperature-controlled floors. Never basements (too humid) or attics (too hot). Target 30-50% humidity and stable temperatures.
...
**Short answer:** $0.35-1.50 per photo for professional scanning services, or $220-549 for your own scanner (amortizes to ~$0.67/photo). A smartphone app is free for small collections.
...
**Short answer:** Often yes — AI successfully restored 71% of my water-damaged photos to print quality. The key factor is whether the image layer (emulsion) is still intact.
...
**Short answer:** Absolutely yes. The 87 photos I had backed up digitally were the only ones that survived our basement flood. Prevention cost $424 vs. $7,212 in disaster recovery.
...
**Short answer:** Spend 1 hour today: find your 20 most irreplaceable photos, bag them in Ziploc, move them off the floor, and scan them with your phone. Total cost: $0.
