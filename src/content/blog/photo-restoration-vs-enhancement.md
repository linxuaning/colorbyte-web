...
coverEmoji: "🔬"
faq:
  - question: "Can AI restoration handle photo restoration vs photo enhancement?"
    answer: "Yes. AI restoration via GFPGAN (face) + Real-ESRGAN (upscale) handles most cases of photo restoration vs photo enhancement effectively. Upload, wait ~60 seconds, download. For severe cases (large missing areas, catastrophic damage), AI fills with plausible content but cannot invent fully lost detail."
