---
title: "How to Fix Underexposed Old Photographs: Brighten Dark Vintage Photos"
description: "Learn techniques to restore underexposed dark photographs. Complete guide to brightening, enhancing detail, and recovering images from too-dark vintage photos."
...
featured: false
faq:
  - question: "Can AI restoration handle fix underexposed old photographs?"
    answer: "Yes. AI restoration via GFPGAN (face) + Real-ESRGAN (upscale) handles most cases of fix underexposed old photographs effectively. Upload, wait ~60 seconds, download. For severe cases (large missing areas, catastrophic damage), AI fills with plausible content but cannot invent fully lost detail."
...
| Aspect | Underexposure | Overexposure |
|--------|--------------|--------------|
| Shadow detail | Present but dark | Usually good |
| Highlight detail | Usually preserved | Often lost |
...
1. **Brighten dramatically** in photo software
2. **Examine shadow areas** at high magnification
3. **Check for faces** in dark regions
4. **Look for edge detail** and textures
...
Our [AI restoration tool](/restore-old-family-photos) automatically brightens underexposed areas while controlling noise.
...
2. Move black point right to set true black
3. Move white point left if needed
4. Adjust midtone gamma upward (left)
5. Watch histogram for clipping

**Curves Adjustment**:
1. Create curve lifting shadows
2. Pull shadow quarter-tone up
3. Maintain highlight region
4. Add contrast in midtones
5. S-curve for pop

**Shadow/Highlight Tool**:
1. Increase shadow amount
2. Adjust tonal width for shadows
3. May need radius adjustment
4. Add midtone contrast
5. Often good starting point

**Exposure Adjustment**:
1. Increase overall exposure
2. Use offset to protect highlights
3. Gamma for midtone control
4. Watch for clipping
...
Our [AI photo upscaler](/ai-photo-upscaler) includes noise reduction that works well on brightened images.
...
Short answer: Usually yes. Underexposed photos typically contain hidden detail that can be revealed through brightening. Even photos that appear nearly black often have recoverable information. Our [enhancement tool](/enhance-old-photos) can brighten severely dark photos while controlling noise.
...
Short answer: Often yes, remarkably well. AI facial recognition can identify and enhance faces even in heavy shadow. The technology reconstructs facial detail based on what's visible combined with learned face patterns. Our [family photo restoration tool](/restore-old-family-photos) excels at recovering shadowed faces.
