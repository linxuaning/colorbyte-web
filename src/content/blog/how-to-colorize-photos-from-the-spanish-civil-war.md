...
faq:
  ...
  - question: "Is it historically responsible to colorize Spanish Civil War photographs?"
    answer: "Colorizing historical war photographs is defensible when handled with proper disclosure. For archival and scholarly use, the original black-and-white photograph is the authentic document — any colorized version is a derivative interpretation, not a record. Colorized versions must be clearly labeled as digitally enhanced, never presented as original color photographs. For educational use — classroom presentations, documentary film, museum displays for general audiences — colorization helps contemporary viewers engage with historical imagery by reducing the perceptual distance that black-and-white creates. The colors DDColor assigns are historically plausible for the uniform types, landscape, and materials visible in the image, but they are inference from training data, not photographic record. A fair practice is publishing original and colorized versions side by side with a note explaining the colorization process, its historical basis, and its interpretive limitations."
---
...
4. **Evaluate the result against historical references.** Check uniform colors against documented photographs of the same unit or equipment. Check landscape colors against the known theater of operations.
