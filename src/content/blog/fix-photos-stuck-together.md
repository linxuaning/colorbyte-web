...
|------|-------|----------------------|--------------|
| Surface tack | Humidity | Easy-Moderate | 90%+ |
| Edge bonding | Light water/humidity | Moderate | 80-90% |
...
1. **Scan the fused photos as-is** - High resolution, both sides if relevant
