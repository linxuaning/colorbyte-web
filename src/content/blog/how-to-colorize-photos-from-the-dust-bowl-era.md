...
description: "How to accurately colorize 1930s Dust Bowl photos using AI. Covers FSA archive color references, DDColor accuracy on high-contrast documentary photography, and period-correct palette."
...
faq:
  ...
  - question: "Where can I find reliable color references for 1930s Great Plains clothing and landscapes?"
    answer: "The FSA-OWI collection at the Library of Congress is the primary source, and it includes a subset of color Kodachrome images taken between 1939 and 1943 that document the same subject matter — Great Plains farmers, migratory workers, rural homes — in actual color. These images provide ground truth for soil colors (the Panhandle's red-brown clay, Kansas wheat-field gold, Oklahoma red dirt), vegetation (dry-grass tan, scrub cedar grey-green), and common clothing (faded denim blue, natural cotton cream, printed cotton gingham in red-and-white or blue-and-white checks). The Smithsonian National Museum of American History holds textile samples from the period. The Oklahoma Historical Society and the Kansas Historical Society maintain regional photograph collections with color documentation. For a quick reference baseline, search the Library of Congress digital catalog for Kodachrome 1939-1943 FSA, which returns directly usable comparison images."
