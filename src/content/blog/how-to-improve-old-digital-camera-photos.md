...
**Small sensors with large noise.** Early consumer cameras used 1/3" or 1/4" sensors — significantly smaller than the 1/2.3" sensors in later point-and-shoots. These tiny sensors showed visible noise in any condition below bright midday light. Indoor birthday parties, holiday dinners, and evening events produced heavily grainy images that were usually accepted at the time because there was no practical alternative.
