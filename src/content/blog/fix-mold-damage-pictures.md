...
1. **Isolate Contaminated Photographs** immediately in sealed plastic bags to prevent spread to other images
2. **Move to Dry Environment** to stop active growth—mold requires moisture
3. **Document Current Condition** with photographs before handling
...
Upload digitized images to [ArtImageHub](/old-photo-restoration). The AI identifies and removes mold damage patterns.
...
| Severity | Visual Indicators | Restoration Success | Time Required |
|----------|------------------|---------------------|---------------|
| Light | Few scattered spots | 95%+ | 15-30 min |
| Moderate | Multiple spots, some staining | 85-95% | 30-60 min |
| Heavy | Extensive spots, significant staining | 75-90% | 1-2 hours |
| Severe | Widespread damage, emulsion loss | 60-80% | 2-4 hours |
| Catastrophic | Near-complete coverage, severe loss | 40-70% | 4+ hours |
