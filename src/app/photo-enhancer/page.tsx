...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is AI photo enhancement free?", acceptedAnswer: { "@type": "Answer", text: "Yes — ArtImageHub offers a free trial with 3 photos to test the AI enhancement quality, no account or credit card required. Pro Lifetime is a one-time payment of $4.99 for unlimited enhancements in original resolution with no watermark, lifetime access." } },
