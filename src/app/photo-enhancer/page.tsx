...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: "The AI enhances your photo with face-aware processing and 4× super resolution. Most enhancements complete in about 30–60 seconds; very large 50+ MP scans can take up to 60 seconds.",
    },
    {
      "@type": "HowToStep",
      position: 4,
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How long does AI photo enhancement actually take per image?", acceptedAnswer: { "@type": "Answer", text: "Most photos finish enhancement in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time depends on damage and content complexity (such as the number of faces) rather than image size — the AI works at a standardized internal resolution, so a phone photo and a high-resolution scan take about the same time. Most enhancements finish in 30–60 seconds, with complex images taking up to 90 seconds. Face-forward photos take slightly longer because GFPGAN runs an additional face-detection and reconstruction pass for each detected face. The combined Real-ESRGAN + GFPGAN pipeline runs in a single forward pass rather than sequentially, which keeps total time below most users' patience threshold. Processing speed is the same for paid users; the $4.99 unlock buys AI enhancement and the HD original-quality download, not a faster queue." } },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-[#d2d2d7]/40 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-5">
          ...
          <p className="text-[16px] text-[#444] leading-[1.7] mb-5">
            ArtImageHub&rsquo;s Photo Enhancer runs this full pipeline in a single upload pass — no manual step selection required. Processing takes about 30–60 seconds (up to 60 seconds for very large 50+ MP scans). AI processing and HD download are included in the one-time $4.99 unlock.
          </p>
          ...
          <dl className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Most photos finish enhancement in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time depends on damage and content complexity (such as the number of faces) rather than image size — the AI works at a standardized internal resolution, so a phone photo and a high-resolution scan take about the same time. Most enhancements finish in 30–60 seconds, with complex images taking up to 90 seconds. Face-forward photos take slightly longer because GFPGAN runs an additional face-detection and reconstruction pass for each detected face. The combined Real-ESRGAN + GFPGAN pipeline runs in a single forward pass rather than sequentially, which keeps total time below most users' patience threshold. Processing speed is the same for paid users; the $4.99 unlock buys AI enhancement and the HD original-quality download, not a faster queue.",
              },
              {
