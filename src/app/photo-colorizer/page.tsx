...
export const metadata: Metadata = {
  ...
  description:
    "AI photo colorizer for black and white photos. Turn old family photos and historical images into vivid color in 30–60 seconds with a $4.99 one-time unlock.",
  alternates: {
...
const howToSchema = {
  ...
  description: "Add realistic colors to black and white photos using AI colorization — $4.99 one-time unlock, results in 30–60 seconds.",
  totalTime: "PT1M",
  ...
  step: [
    ...
    },
    {
      ...
      text: "The AI processes your photo and applies natural-looking colors. Most colorizations complete in 30–60 seconds.",
    },
    {
      "@type": "HowToStep",
      position: 4,
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How long does AI photo colorization actually take per image?", acceptedAnswer: { "@type": "Answer", text: "Most photos finish colorization in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time scales with image dimensions: a typical 4 by 6 inch print scanned at 600 DPI (about 6 megapixels) finishes in 30–60 seconds, a high-resolution 1200 DPI scan of the same print (about 25 megapixels) takes 30–60 seconds, and very large 50-plus megapixel scans can take up to 30–60 seconds. The DDColor model runs the full image through the transformer in a single forward pass without tiling for images under 25 megapixels, which avoids edge artifacts at tile boundaries. Processing speed is the same for paid users; the $4.99 unlock buys AI processing and the HD original-quality download, not a faster queue." } },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-[#d2d2d7]/40 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-5">
          ...
          <p className="text-[16px] text-[#444] leading-[1.7] mb-5">
            ArtImageHub&rsquo;s Photo Colorizer applies this pipeline in a single upload pass, completing colorization in 30–60 seconds. AI processing and HD download are included in the one-time $4.99 unlock. Supported formats: JPG, PNG, WEBP up to 20MB.
          </p>
          ...
          <dl className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Most photos finish colorization in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time scales with image dimensions: a typical 4 by 6 inch print scanned at 600 DPI (about 6 megapixels) finishes in 30–60 seconds, a high-resolution 1200 DPI scan of the same print (about 25 megapixels) takes 30–60 seconds, and very large 50-plus megapixel scans can take up to 30–60 seconds. The DDColor model runs the full image through the transformer in a single forward pass without tiling for images under 25 megapixels, which avoids edge artifacts at tile boundaries. Processing speed is the same for paid users; the $4.99 unlock buys AI processing and the HD original-quality download, not a faster queue.",
              },
              {
              ...
              },
              {
                ...
                a: "AI colorization (DDColor on ArtImageHub) predicts plausible colors automatically in 30–60 seconds for $4.99 one-time. Professional hand-coloring by a trained colorist requires 2 to 8 hours of manual painting per photo and typically costs $150 to $500 per image, but it can incorporate historically verified reference sources to produce period-accurate palettes (correct military uniform colors, specific brand identities, historically documented clothing dyes). For family archive use where the goal is to bring photos to life for display, sharing, and emotional connection rather than historical documentation, AI colorization is the practical choice at one hundred times lower cost. For historically sensitive images intended for academic publication, museum display, or legal documentation, professional hand-coloring with verified historical sources remains the accuracy gold standard. Many family historians use a hybrid: AI for the bulk archive, professional hand-coloring for the most important 1 to 5 photos.",
              },
              {
