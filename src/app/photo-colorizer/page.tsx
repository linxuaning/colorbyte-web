...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: "The AI processes your photo and applies natural-looking colors. Most colorizations complete in about 30–60 seconds; very large 50+ MP scans can take up to 60 seconds.",
    },
    {
      "@type": "HowToStep",
      position: 4,
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How long does AI photo colorization actually take per image?", acceptedAnswer: { "@type": "Answer", text: "Most photos finish colorization in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time stays roughly the same whether you upload a phone photo or a high-resolution scan, because the AI works at a standardized internal resolution — most colorizations finish in 30–60 seconds, with heavily damaged or complex images taking up to 90 seconds. The DDColor model runs the full image through the transformer in a single forward pass without tiling for images under 25 megapixels, which avoids edge artifacts at tile boundaries. Processing speed is the same for paid users; the $4.99 unlock buys AI processing and the HD original-quality download, not a faster queue." } },
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-t border-[#d2d2d7]/40 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-5">
          ...
          <p className="text-[16px] text-[#444] leading-[1.7] mb-5">
            ArtImageHub&rsquo;s Photo Colorizer applies this pipeline in a single upload pass, completing colorization in about 30–60 seconds (up to 60 seconds for very large 50+ MP scans). AI processing and HD download are included in the one-time $4.99 unlock. Supported formats: JPG, PNG, WEBP up to 20MB.
          </p>
          ...
          <dl className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Most photos finish colorization in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time stays roughly the same whether you upload a phone photo or a high-resolution scan, because the AI works at a standardized internal resolution — most colorizations finish in 30–60 seconds, with heavily damaged or complex images taking up to 90 seconds. The DDColor model runs the full image through the transformer in a single forward pass without tiling for images under 25 megapixels, which avoids edge artifacts at tile boundaries. Processing speed is the same for paid users; the $4.99 unlock buys AI processing and the HD original-quality download, not a faster queue.",
              },
              {
