...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: "The AI processes your photo with face-aware enhancement and super resolution upscaling to fix blur and restore clarity. Most images are unblurred in about 30–60 seconds; very large images can take up to 60 seconds.",
    },
    {
      "@type": "HowToStep",
      position: 4,
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Unblur Photo", item: "https://artimagehub.com/unblur-photo" },
  ],
};
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  a: "Most photos are unblurred in 30–60 seconds. Very large images may take up to 60 seconds.",
                },
              ].map((item) => (
                <details
                  key={item.q}
