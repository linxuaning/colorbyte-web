...
const config: BuyerGuideConfig = {
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: 'Most modern AI restoration apps process a single photo in 30–60 seconds. ArtImageHub typically completes a full pass (restoration + colorization + enhancement) in 30–60 seconds depending on the source photo size. Remini processes faces in 30–60 seconds. MyHeritage takes 30–60 seconds for the combined Restore + Enhance + Colorize workflow. VanceAI varies based on which models you apply but is in the same range. Compared to manual restoration in Photoshop or GIMP, which takes 30–90 minutes per photo, AI restoration is roughly 100× faster. For a typical family album with 50 photos, manual restoration would take 25–75 hours of work; AI restoration takes 30–45 minutes total including upload and review time. The speed advantage is one of the main reasons AI restoration has become the default for family photo projects, even when manual restoration would produce slightly better results on the most damaged photos.',
    },
    {
