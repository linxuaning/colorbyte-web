...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Most photos finish denoising in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time stays roughly the same whether you upload a phone photo or a high-resolution scan, because the AI works at a standardized internal resolution — most photos finish in 30–60 seconds, with heavily noisy or damaged images taking up to 90 seconds. If you are processing a batch of denoising work, the per-image cost stays consistent — there is no warmup penalty after the first image, since the model stays loaded between requests for paid users. Processing time is the same for paid users.",
      },
    },
    {
      "@type": "Question",
          ...
          <dl className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Most photos finish denoising in 30–60 seconds end-to-end, including upload, AI processing, and result rendering. Processing time stays roughly the same whether you upload a phone photo or a high-resolution scan, because the AI works at a standardized internal resolution — most photos finish in 30–60 seconds, with heavily noisy or damaged images taking up to 90 seconds. If you are processing a batch of denoising work, the per-image cost stays consistent — there is no warmup penalty after the first image, since the model stays loaded between requests for paid users. Processing time is the same for paid users.",
              },
              {
