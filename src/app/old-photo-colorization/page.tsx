...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Most photos are colorized in 30–60 seconds. Complex images with many fine details may take up to 60 seconds. You'll see the result as soon as processing completes.",
      },
    },
    {
      "@type": "Question",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Old Photo Colorization", item: "https://artimagehub.com/old-photo-colorization" },
  ],
};
          ...
          <dl className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Most photos are colorized in 30–60 seconds. Complex images with many fine details may take up to 60 seconds.",
              },
              {
