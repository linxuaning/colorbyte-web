...
const howToSchema = {
  ...
  step: [
    ...
    },
    {
      ...
      text: "AI analyzes damage and applies restoration: removes scratches, enhances faces, restores colors, repairs tears. Takes 30–90 seconds.",
    },
    {
      "@type": "HowToStep",
      position: 3,
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How long does picture restoration take?", acceptedAnswer: { "@type": "Answer", text: "AI picture restoration takes 30–90 seconds per picture. Traditional mail-in services take 2-4 weeks. You upload, AI processes in under two minutes, and you download." } },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Picture Restoration", item: "https://artimagehub.com/picture-restoration" },
  ],
};
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-lg text-slate-700 leading-relaxed">
                  AI restores your picture: removes scratches, repairs tears, restores faded colors, sharpens faces, fixes damage. All fixes happen automatically in 30–90 seconds. No editing skills required.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid sm:grid-cols-3 gap-6 text-center">
            ...
            <div>
              ...
              <div className="text-slate-700">One-time original-quality unlock</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <details className="bg-amber-50 rounded-xl p-6 border-2 border-amber-200 group">
              ...
              <p className="mt-4 text-slate-700 leading-relaxed">
                AI picture restoration takes 30–90 seconds per picture. Traditional mail-in services take 2-4 weeks. You upload, AI processes in under two minutes, and you download.
              </p>
            </details>
