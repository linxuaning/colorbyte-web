...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Is the photo enhancer free to use?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes — enhancement preview is free. Download the original quality result requires Pro Lifetime Access ($4.99 one-time). No subscription.",
      },
    },
    {
      "@type": "Question",
      name: "How long does AI photo enhancement take?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Most photos are enhanced in 30 seconds. Complex images may take up to 90 seconds.",
      },
    },
    {
      "@type": "Question",
