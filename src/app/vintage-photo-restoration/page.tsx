        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <Link href="/old-photo-restoration" className="block p-4 bg-white rounded-lg border border-[#d2d2d7]/60 hover:border-amber-500/40 hover:shadow-sm transition-all">
              ...
              <p className="text-[13px] text-[#6e6e73]">All-purpose photo restoration</p>
            </Link>
            ...
            <Link href="/restore-old-family-photos" className="block p-4 bg-white rounded-lg border border-[#d2d2d7]/60 hover:border-amber-500/40 hover:shadow-sm transition-all">
              <h4 className="font-semibold text-[#1d1d1f] mb-1">Family Photo Restoration</h4>
              <p className="text-[13px] text-[#6e6e73]">Preserve family memories</p>
            </Link>
          </div>
        </div>
      </section>
