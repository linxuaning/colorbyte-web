...
const softwareSchema = {
  ...
  name: "ArtImageHub Vintage Photo Restoration",
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "What is the best way to restore vintage photos while keeping the old look?", acceptedAnswer: { "@type": "Answer", text: geoAnswer } },
