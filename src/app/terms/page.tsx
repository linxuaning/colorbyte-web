      ...
      <div className="mx-auto max-w-3xl px-6 py-16 lg:py-20">
        ...
        <div className="font-lora text-[16px] leading-[1.8] text-[#4a3728] space-y-8">
          <section>
            ...
            <p>
              By accessing or using ArtImageHub (&quot;Service&quot;) at www.artimagehub.com, you agree to be bound by these Terms of Service.
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:support@www.artimagehub.com" className="text-[#8B5E3C] underline">
                support@www.artimagehub.com
              </a>
            </p>
          </section>
        </div>
