...
export const metadata: Metadata = {
  ...
  description: "Guides, tools, and resources for restoring old photos, preserving family history, and getting the most from AI photo restoration. $4.99 one-time unlock for upload, AI processing, and original-quality download.",
  alternates: { canonical: "/resources" },
  openGraph: {
    title: "Photo Restoration Resources & Guides",
    description: "Guides and tools for restoring and preserving old family photos with a pay-first workflow.",
    type: "website",
  },
};
      ...
      <header className="border-b border-[#d4bc91]/60 bg-[#faf8f4] py-14 sm:py-20">
        <div className="mx-auto max-w-5xl px-6 lg:px-10">
          ...
          <p className="mt-6 font-lora text-[17px] text-[#6b5344] max-w-2xl leading-[1.7]">
            ...
            Pay-first tools, expert guides, and curated external resources — all in one place.
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-5xl px-6 lg:px-10 py-14 sm:py-20 space-y-20">
        ...
        <section>
          <div className="mb-8 flex items-center gap-4">
            <div className="h-px w-8 bg-[#8B5E3C]" aria-hidden="true" />
            <h2 className="font-playfair text-[24px] font-700 text-[#2c2416]">Pay-First AI Tools</h2>
